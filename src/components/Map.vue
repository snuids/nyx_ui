<template>
  ...
  <div style="height: 400px;width:100%;">    
    <l-map :zoom="zoom" :center="center">
      ...
      <l-marker v-for="item in markers" :key="item.id" :lat-lng="item.latlng" @click="markerClicked(item)">
...
export default {
  ...
  mounted: function() {
    ...
    this.center=L.latLng(this.config.config.maplong, this.config.config.maplat);
    //alert(this.zoom)
