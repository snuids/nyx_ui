<template>
  <el-dialog width="60%" title="Edit Scheduler" :visible.sync="visible" :before-close="closeDialog">
    <el-tabs v-model="activeName">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="Report" :label-width="formLabelWidth">
                <el-select size="mini" @change="reportChange" v-model="record._source.report" placeholder="Select">
                  <el-option
            ...
            <el-col :span="12">
              <el-form-item label="Type" :label-width="formLabelWidth">
                <el-select size="mini" v-model="record._source.trigger.type" placeholder="Select" @change="typeChanged">
      ...
      <el-tab-pane label="Mailing List" name="mailing list">Mailing List
          <div>
        ...
        <el-form>
          ...
          <el-row>
              <el-form-item label="Attach. Name" :label-width="formLabelWidth">
                <el-input placeholder="MyFile-${DATE:%d%B%Y}" size="mini" v-model="record._source.attachmentName" autocomplete="off"></el-input>
              </el-form-item>
          </el-row>          
...
export default {
  ...
  methods: {
    ...
    resetTask: function(record) {
      var newrun=moment(record._source.nextRun).subtract(this.resetdays, "days");
